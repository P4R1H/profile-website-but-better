                  ...
                  >
                    ...
                    <AnimatePresence>
                      {isExpanded && !project.isExpandable && (
                        ...
                        >
                          <div className="pb-3 md:pb-4 md:pt-1 md:pl-36 md:pr-8">
                            {/* Mobile: Show description + links/stack */}
                                ...
                                <div className="flex gap-2">
                                  {project.links.github && (
                                    <a
                                      ...
                                      className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs text-zinc-400 hover:text-zinc-200 border border-zinc-800 hover:border-zinc-600 transition-colors"
                                    >
                            ...
                            {/* Desktop: Show only links if available, otherwise show full stack */}
